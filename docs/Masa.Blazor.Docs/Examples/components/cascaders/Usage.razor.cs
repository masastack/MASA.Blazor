...
public class Usage : Masa.Blazor.Docs.Components.Usage
{
    ...
    {
        { nameof(MCascader<CascaderNode, string>.Dense), new CheckboxParameter("false", true)  },
        { nameof(MCascader<CascaderNode, string>.ShowAllLevels), new CheckboxParameter("false", true)  },
        { nameof(MCascader<CascaderNode, string>.ChangeOnSelect), new CheckboxParameter("false", true) },
    };
    ...
    protected override Dictionary<string, object>? GenAdditionalParameters()
    {
        ...
        {
            { nameof(MCascader<CascaderNode, string>.Value), _value},
            { nameof(MCascader<CascaderNode, string>.ValueChanged), EventCallback.Factory.Create<string>(this, x => _value = x) },
            ...
            {
                nameof(MCascader<CascaderNode, string>.ItemChildren),
                (Func<CascaderNode, List<CascaderNode>>)(x => x.Children)
            },
