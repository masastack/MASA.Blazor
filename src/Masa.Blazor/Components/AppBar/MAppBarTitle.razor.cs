...
public partial class MAppBarTitle : MasaComponentBase
{
    ...
    private string? GetContentStyle()
    {
        ...
        // The '+1' offset ensures proper visual alignment or accounts for potential rounding errors in width calculation.
    ...
    private async Task UpdateDimensions()
    {
        ...
        var element = await Js.InvokeAsync<Masa.Blazor.JSInterop.Element>(JsInteropConstants.GetDomInfo, _contentElement);
