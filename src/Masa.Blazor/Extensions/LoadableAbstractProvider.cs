namespace Masa.Blazor
{
    ...
    {
        public static ComponentAbstractProvider ApplyLoadable(this ComponentAbstractProvider abstractProvider, StringBoolean? loading, string? color,
            StringNumber loaderHeight)
        {
            return abstractProvider
                   ...
                   .Apply(typeof(BProgressLinear), typeof(MProgressLinear), attrs =>
                   {
                       ...
                       attrs[nameof(MProgressLinear.Color)] = loading is not null && (loading == true || loading == "")
                           ? color ?? "primary"
