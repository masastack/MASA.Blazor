...
using ExampleComponents = Masa.Blazor.Docs.Examples.components;

namespace Masa.Blazor.Docs;

public static class CircuitRootComponentOptionsExtensions
{
    public static void RegisterCustomElementsOfMasaBlazorDocs(this IJSComponentConfiguration options)
    {
